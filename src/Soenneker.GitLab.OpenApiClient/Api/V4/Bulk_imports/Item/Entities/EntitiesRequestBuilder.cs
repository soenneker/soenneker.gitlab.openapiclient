...
using Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.Item;
...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities
{
    ...
    public partial class EntitiesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.Item.WithEntity_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("entity_id", position);
                return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.Item.WithEntity_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder.EntitiesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder.EntitiesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This feature was introduced in GitLab 14.1.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Return import entities with specified status</summary>
            [QueryParameter("status")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.GetStatusQueryParameterType? StatusAsGetStatusQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EntitiesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Bulk_imports.Item.Entities.EntitiesRequestBuilder.EntitiesRequestBuilderGetQueryParameters>
        {
        }
    }
}
