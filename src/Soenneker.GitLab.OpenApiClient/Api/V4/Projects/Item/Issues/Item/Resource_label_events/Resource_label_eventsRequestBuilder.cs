...
using Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Item;
...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events
{
    ...
    public partial class Resource_label_eventsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder.Resource_label_eventsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder.Resource_label_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This feature was introduced in 11.3
        /// </summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Resource_label_eventsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Issues.Item.Resource_label_events.Resource_label_eventsRequestBuilder.Resource_label_eventsRequestBuilderGetQueryParameters>
        {
        }
    }
}
