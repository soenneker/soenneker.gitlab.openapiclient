...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\projects\{-id}\jobs\{jobId}\trace
    /// </summary>
    ...
    public partial class TraceRequestBuilder : BaseRequestBuilder
    {
        ...
        public TraceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/projects/{%2Did}/jobs/{jobId}/trace{?byte_limit*,byte_offset*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Jobs.Item.Trace.TraceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TraceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/projects/{%2Did}/jobs/{jobId}/trace{?byte_limit*,byte_offset*}", rawUrl)
        {
        }
        /// <summary>
