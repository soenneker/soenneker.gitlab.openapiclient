...
using Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item;
...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\projects\{-id}\merge_requests
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class Merge_requestsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.GitLab.OpenApiClient.api.v4.projects.item.merge_requests.item collection</summary>
        /// <param name="position">The internal ID of the merge request.</param>
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item.EventableItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("eventable%2Did", position);
                return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item.EventableItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Merge_requestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/projects/{%2Did}/merge_requests{?approved_by_ids*,approved_by_usernames*,approver_ids*,assignee_id*,assignee_username*,author_id*,author_username*,created_after*,created_before*,deployed_after*,deployed_before*,draft*,environment*,iids,in*,labels,merge_user_id*,merge_user_username*,merged_after*,merged_before*,milestone*,my_reaction_emoji*,not*,not%5Bassignee_id%5D*,not%5Bassignee_username%5D*,not%5Bauthor_id%5D*,not%5Bauthor_username%5D*,not%5Blabels%5D*,not%5Bmilestone%5D*,not%5Bmy_reaction_emoji%5D*,not%5Breviewer_id%5D*,not%5Breviewer_username%5D*,order_by*,page*,per_page*,reviewer_id*,reviewer_username*,scope*,search*,sort*,source_branch*,source_project_id*,state*,target_branch*,updated_after*,updated_before*,view*,wip*,with_labels_details*,with_merge_status_recheck*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder"/> and sets the default values.
...
#nullable enable
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.ApiEntitiesMergeRequestBasic?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.ApiEntitiesMergeRequestBasic> GetAsync(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all project merge requests.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Returns merge requests created by the given `username`. Mutually exclusive with `assignee_id`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            public string[] AssigneeUsername { get; set; }
#endif
            /// <summary>Returns merge requests created by the given user `id`. Combine with `scope=all` or `scope=assigned_to_me`. Mutually exclusive with `author_username`.</summary>
...
#nullable restore
            ...
            public string Environment { get; set; }
#endif
            /// <summary>Returns the request having the given `iid`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("iids")]
...
#nullable restore
            ...
            /// <summary>`&lt;Negated&gt;` Returns merge requests created by the given `username`. Mutually exclusive with `not[assignee_id]`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            public string[] NotassigneeUsername { get; set; }
#endif
            /// <summary>`&lt;Negated&gt;` Returns merge requests created by the given user `id`. Combine with `scope=all` or `scope=assigned_to_me`. Mutually exclusive with `not[author_username]`.</summary>
            [QueryParameter("not%5Bauthor_id%5D")]
            public int? NotauthorId { get; set; }
            /// <summary>`&lt;Negated&gt;` Returns merge requests created by the given `username`. Mutually exclusive with `not[author_id]`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            public string NotmyReactionEmoji { get; set; }
#endif
            /// <summary>`&lt;Negated&gt;` Returns merge requests which have the user as a reviewer with the given user `id`. `None` returns merge requests with no reviewers. `Any` returns merge requests with any reviewer. Mutually exclusive with `not[reviewer_username]`.</summary>
            [QueryParameter("not%5Breviewer_id%5D")]
            public int? NotreviewerId { get; set; }
            /// <summary>`&lt;Negated&gt;` Returns merge requests which have the user as a reviewer with the given `username`. `None` returns merge requests with no reviewers. `Any` returns merge requests with any reviewer. Introduced in GitLab 13.8. Mutually exclusive with `not[reviewer_id]`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>Returns merge requests which have the user as a reviewer with the given `username`. `None` returns merge requests with no reviewers. `Any` returns merge requests with any reviewer. Introduced in GitLab 13.8. Mutually exclusive with `reviewer_id`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            public global::Soenneker.GitLab.OpenApiClient.Models.GetApiV4ProjectsIdMergeRequestsScopeParameter? Scope { get; set; }
...
#nullable restore
            ...
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Models.GetApiV4ProjectsIdMergeRequestsSortParameter? Sort { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.GitLab.OpenApiClient.Models.GetApiV4ProjectsIdMergeRequestsStateParameter? State { get; set; }
...
#nullable restore
            ...
            [QueryParameter("wip")]
            public global::Soenneker.GitLab.OpenApiClient.Models.GetApiV4ProjectsIdMergeRequestsWipParameter? Wip { get; set; }
