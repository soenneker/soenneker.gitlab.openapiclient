...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests
{
    ...
    public partial class Merge_requestsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item.Eventable_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("eventable_%2Did", position);
                return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item.Eventable_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Soenneker.GitLab.OpenApiClient.api.v4.projects.item.merge_requests.item collection</summary>
        /// <param name="position">The internal ID of the merge request.</param>
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Item.Eventable_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.APIEntitiesMergeRequest?> PostAsync(global::Soenneker.GitLab.OpenApiClient.Models.RequestBody_6dfbbd1de69a body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.APIEntitiesMergeRequest> PostAsync(global::Soenneker.GitLab.OpenApiClient.Models.RequestBody_6dfbbd1de69a body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.GitLab.OpenApiClient.Models.RequestBody_6dfbbd1de69a body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.GitLab.OpenApiClient.Models.RequestBody_6dfbbd1de69a body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            /// <summary>Filters merge requests by their `approved` status. `yes` returns only approved merge requests. `no` returns only non-approved merge requests.</summary>
            [QueryParameter("approved")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetApprovedQueryParameterType? ApprovedAsGetApprovedQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns merge requests ordered by `created_at`, `label_priority`, `milestone_due`, `popularity`, `priority`, `title`, `updated_at` or `merged_at` fields. Introduced in GitLab 14.8.</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>&quot;Returns merge requests for the given scope: `created_by_me`, `assigned_to_me`, `reviews_for_me` or `all`&quot;</summary>
            [QueryParameter("scope")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetScopeQueryParameterType? ScopeAsGetScopeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns merge requests sorted in `asc` or `desc` order.</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns `all` merge requests or just those that are `opened`, `closed`, `locked`, or `merged`.</summary>
            [QueryParameter("state")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>If simple, returns the `iid`, URL, title, description, and basic state of merge request</summary>
            [QueryParameter("view")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetViewQueryParameterType? ViewAsGetViewQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter merge requests against their `wip` status. `yes` to return only draft merge requests, `no` to return non-draft merge requests.</summary>
            [QueryParameter("wip")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.GetWipQueryParameterType? WipAsGetWipQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Merge_requestsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Merge_requestsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
