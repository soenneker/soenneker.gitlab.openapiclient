...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>Filters merge requests by their `approved` status. `yes` returns only approved merge requests. `no` returns only non-approved merge requests.</summary>
            [QueryParameter("approved")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetApprovedQueryParameterType? ApprovedAsGetApprovedQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns merge requests ordered by `created_at`, `label_priority`, `milestone_due`, `popularity`, `priority`, `title`, `updated_at` or `merged_at` fields. Introduced in GitLab 14.8.</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>&quot;Returns merge requests for the given scope: `created_by_me`, `assigned_to_me`, `reviews_for_me` or `all`&quot;</summary>
            [QueryParameter("scope")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetScopeQueryParameterType? ScopeAsGetScopeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns merge requests sorted in `asc` or `desc` order.</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Returns `all` merge requests or just those that are `opened`, `closed`, `locked`, or `merged`.</summary>
            [QueryParameter("state")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>If simple, returns the `iid`, URL, title, description, and basic state of merge request</summary>
            [QueryParameter("view")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetViewQueryParameterType? ViewAsGetViewQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter merge requests against their `wip` status. `yes` to return only draft merge requests, `no` to return non-draft merge requests.</summary>
            [QueryParameter("wip")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.GetWipQueryParameterType? WipAsGetWipQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Merge_requestsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Deployments.Item.Merge_requests.Merge_requestsRequestBuilder.Merge_requestsRequestBuilderGetQueryParameters>
        {
        }
    }
}
