...
using System;
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\projects\{-id}\forks
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ForksRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/projects/{%2Did}/forks{?active*,archived*,custom_attributes*,id_after*,id_before*,imported*,include_hidden*,include_pending_delete*,last_activity_after*,last_activity_before*,marked_for_deletion_on*,membership*,min_access_level*,order_by*,owned*,page*,per_page*,repository_checksum_failed*,repository_storage*,search*,search_namespaces*,simple*,sort*,starred*,topic,topic_id*,updated_after*,updated_before*,visibility*,wiki_checksum_failed*,with_custom_attributes*,with_issues_enabled*,with_merge_requests_enabled*,with_programming_language*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/projects/{%2Did}/forks{?active*,archived*,custom_attributes*,id_after*,id_before*,imported*,include_hidden*,include_pending_delete*,last_activity_after*,last_activity_before*,marked_for_deletion_on*,membership*,min_access_level*,order_by*,owned*,page*,per_page*,repository_checksum_failed*,repository_storage*,search*,search_namespaces*,simple*,sort*,starred*,topic,topic_id*,updated_after*,updated_before*,visibility*,wiki_checksum_failed*,with_custom_attributes*,with_issues_enabled*,with_merge_requests_enabled*,with_programming_language*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.APIEntitiesProject?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder.ForksRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitLab.OpenApiClient.Models.APIEntitiesProject> GetAsync(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder.ForksRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder.ForksRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder.ForksRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List forks of this project
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Return projects ordered by field. storage_size, repository_size, wiki_size, packages_size are only available to admins. Similarity is available when searching and is limited to projects the user has access to.</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return projects sorted in ascending and descending order</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Limit by visibility</summary>
            [QueryParameter("visibility")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.GetVisibilityQueryParameterType? VisibilityAsGetVisibilityQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ForksRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Projects.Item.Forks.ForksRequestBuilder.ForksRequestBuilderGetQueryParameters>
        {
        }
    }
}
