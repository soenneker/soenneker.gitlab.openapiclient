...
using System;
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\admin\batched_background_operations
    /// </summary>
    ...
    public partial class Batched_background_operationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Batched_background_operationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/admin/batched_background_operations{?database*,job_class_name*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Batched_background_operationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/admin/batched_background_operations{?database*,job_class_name*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder.Batched_background_operationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder.Batched_background_operationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Batched_background_operations.Batched_background_operationsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This feature was introduced in GitLab 19.1.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Batched_background_operationsRequestBuilderGetQueryParameters 
        {
