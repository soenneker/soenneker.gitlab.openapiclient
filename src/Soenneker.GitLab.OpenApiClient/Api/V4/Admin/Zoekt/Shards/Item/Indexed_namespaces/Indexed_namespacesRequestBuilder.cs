...
using Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Item;
...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces
{
    ...
    public partial class Indexed_namespacesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Item.WithNamespace_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("namespace_id", position);
                return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Item.WithNamespace_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Indexed_namespacesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Indexed_namespacesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Indexed_namespacesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Admin.Zoekt.Shards.Item.Indexed_namespaces.Indexed_namespacesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Indexed_namespacesRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
