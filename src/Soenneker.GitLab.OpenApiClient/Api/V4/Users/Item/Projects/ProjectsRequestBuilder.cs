...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects
{
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/users/{%2Did}/projects{?active*,archived*,custom_attributes*,id_after*,id_before*,imported*,include_hidden*,include_pending_delete*,last_activity_after*,last_activity_before*,marked_for_deletion_on*,membership*,min_access_level*,order_by*,owned*,page*,per_page*,repository_checksum_failed*,repository_storage*,search*,search_namespaces*,simple*,sort*,starred*,statistics*,topic,topic_id*,updated_after*,updated_before*,visibility*,wiki_checksum_failed*,with_custom_attributes*,with_issues_enabled*,with_merge_requests_enabled*,with_programming_language*}", rawUrl)
        {
        }
        /// <summary>
        /// Get a user projects
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.ProjectsRequestBuilder.ProjectsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.ProjectsRequestBuilder.ProjectsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.ProjectsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.ProjectsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>Return projects ordered by field. storage_size, repository_size, wiki_size, packages_size are only available to admins. Similarity is available when searching and is limited to projects the user has access to.</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return projects sorted in ascending and descending order</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Limit by visibility</summary>
            [QueryParameter("visibility")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.GetVisibilityQueryParameterType? VisibilityAsGetVisibilityQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ProjectsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Users.Item.Projects.ProjectsRequestBuilder.ProjectsRequestBuilderGetQueryParameters>
        {
        }
    }
}
