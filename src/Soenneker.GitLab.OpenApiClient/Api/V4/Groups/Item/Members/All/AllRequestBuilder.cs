...
using Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.Item;
...
using System;
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\groups\{id}\members\all
    /// </summary>
    ...
    public partial class AllRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.Item.WithUser_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/members/all{?page*,per_page*,query*,show_seat_info*,state*,user_ids}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/members/all{?page*,per_page*,query*,show_seat_info*,state*,user_ids}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>Filter results by member state</summary>
            [QueryParameter("state")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AllRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Members.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>
        {
        }
    }
}
