...
using Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Item;
...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens
{
    ...
    public partial class Personal_access_tokensRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder.Personal_access_tokensRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder.Personal_access_tokensRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all personal access tokens for a specified group service account
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Filter tokens which are either active or not</summary>
            [QueryParameter("state")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Personal_access_tokensRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Service_accounts.Item.Personal_access_tokens.Personal_access_tokensRequestBuilder.Personal_access_tokensRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
