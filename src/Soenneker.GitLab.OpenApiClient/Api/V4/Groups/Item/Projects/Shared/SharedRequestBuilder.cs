...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\groups\{id}\projects\shared
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SharedRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SharedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/projects/shared{?archived*,custom_attributes*,min_access_level*,order_by*,page*,per_page*,search*,simple*,sort*,starred*,visibility*,with_custom_attributes*,with_issues_enabled*,with_merge_requests_enabled*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SharedRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/projects/shared{?archived*,custom_attributes*,min_access_level*,order_by*,page*,per_page*,search*,simple*,sort*,starred*,visibility*,with_custom_attributes*,with_issues_enabled*,with_merge_requests_enabled*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>Return projects ordered by field</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return projects sorted in ascending and descending order</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Limit by visibility</summary>
            [QueryParameter("visibility")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.GetVisibilityQueryParameterType? VisibilityAsGetVisibilityQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SharedRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Projects.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>
        {
        }
    }
}
