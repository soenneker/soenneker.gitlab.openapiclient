...
using System;
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\groups\{id}\descendant_groups
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class Descendant_groupsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Descendant_groupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/descendant_groups{?active*,all_available*,archived*,custom_attributes*,marked_for_deletion_on*,min_access_level*,order_by*,owned*,page*,per_page*,repository_storage*,search*,skip_groups,sort*,statistics*,top_level_only*,visibility*,with_custom_attributes*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Descendant_groupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/descendant_groups{?active*,all_available*,archived*,custom_attributes*,marked_for_deletion_on*,min_access_level*,order_by*,owned*,page*,per_page*,repository_storage*,search*,skip_groups,sort*,statistics*,top_level_only*,visibility*,with_custom_attributes*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder.Descendant_groupsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder.Descendant_groupsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>Order by name, path, id or similarity if searching</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Sort by asc (ascending) or desc (descending)</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Limit by visibility</summary>
            [QueryParameter("visibility")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.GetVisibilityQueryParameterType? VisibilityAsGetVisibilityQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Descendant_groupsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Descendant_groups.Descendant_groupsRequestBuilder.Descendant_groupsRequestBuilderGetQueryParameters>
        {
        }
    }
}
