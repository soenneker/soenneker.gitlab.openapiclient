...
using Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Wiki_pages.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Wiki_pages
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v4\groups\{id}\wiki_pages
    /// </summary>
    ...
    public partial class Wiki_pagesRequestBuilder : BaseRequestBuilder
    {
        ...
        public Wiki_pagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/wiki_pages", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Wiki_pages.Wiki_pagesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Wiki_pagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/wiki_pages", rawUrl)
        {
        }
    }
}
