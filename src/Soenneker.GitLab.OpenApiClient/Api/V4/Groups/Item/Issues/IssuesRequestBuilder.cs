...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.IssuesRequestBuilder.IssuesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.IssuesRequestBuilder.IssuesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.IssuesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.IssuesRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>&quot;Return issues that have no due date (`0`), or whose due date is this week, this month, between two weeks ago and next month, or which are overdue. Accepts: `overdue`, `week`, `month`, `next_month_and_previous_two_weeks`, `0`&quot;</summary>
            [QueryParameter("due_date")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetDue_dateQueryParameterType? DueDateAsGetDueDateQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>&quot;The health status of the issue. Must be one of: on_track, needs_attention, at_risk, none, any&quot;</summary>
            [QueryParameter("health_status")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetHealth_statusQueryParameterType? HealthStatusAsGetHealthStatusQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>&quot;The type of the issue. Accepts: issue, incident, test_case, requirement, task, ticket&quot;</summary>
            [QueryParameter("issue_type")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetIssue_typeQueryParameterType? IssueTypeAsGetIssueTypeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return issues assigned to milestones with the specified timebox value (&quot;Any&quot;, &quot;None&quot;, &quot;Upcoming&quot; or &quot;Started&quot;)</summary>
            [QueryParameter("milestone_id")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetMilestone_idQueryParameterType? MilestoneIdAsGetMilestoneIdQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return issues assigned to milestones without the specified timebox value (&quot;Any&quot;, &quot;None&quot;, &quot;Upcoming&quot; or &quot;Started&quot;)</summary>
            [QueryParameter("not%5Bmilestone_id%5D")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetNotMilestone_idQueryParameterType? NotmilestoneIdAsGetNotMilestoneIdQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return issues ordered by `created_at`, `due_date`, `label_priority`, `milestone_due`, `popularity`, `priority`, `relative_position`, `title`, or `updated_at` fields.</summary>
            [QueryParameter("order_by")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetOrder_byQueryParameterType? OrderByAsGetOrderByQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>&quot;Return issues for the given scope: `created_by_me`, `assigned_to_me` or `all`&quot;</summary>
            [QueryParameter("scope")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetScopeQueryParameterType? ScopeAsGetScopeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return issues sorted in `asc` or `desc` order.</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Return opened, closed, or all issues</summary>
            [QueryParameter("state")]
            public global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class IssuesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Issues.IssuesRequestBuilder.IssuesRequestBuilderGetQueryParameters>
        {
        }
    }
}
