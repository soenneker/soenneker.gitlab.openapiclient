...
namespace Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Ldap_group_links
{
    ...
    public partial class Ldap_group_linksRequestBuilder : BaseRequestBuilder
    {
        ...
        public Ldap_group_linksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/ldap_group_links{?cn*,filter*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Api.V4.Groups.Item.Ldap_group_links.Ldap_group_linksRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Ldap_group_linksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v4/groups/{id}/ldap_group_links{?cn*,filter*}", rawUrl)
        {
        }
        /// <summary>
