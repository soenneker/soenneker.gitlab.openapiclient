...
namespace Soenneker.GitLab.OpenApiClient.Models
{
    ...
    public partial class RequestBody0B4A46Acc458 : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The APNs environment the token was issued for</summary>
        public global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458ApnsEnvironment? ApnsEnvironment { get; set; }
...
#nullable restore
        ...
        /// </summary>
        public RequestBody0B4A46Acc458()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "apns_environment", n => { ApnsEnvironment = n.GetEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458ApnsEnvironment>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody0B4A46Acc458ApnsEnvironment>("apns_environment", ApnsEnvironment);
