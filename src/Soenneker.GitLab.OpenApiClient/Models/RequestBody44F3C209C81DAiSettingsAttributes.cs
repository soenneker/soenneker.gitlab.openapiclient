...
namespace Soenneker.GitLab.OpenApiClient.Models
{
    ...
    public partial class RequestBody44F3C209C81DAiSettingsAttributes : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributesPromptInjectionProtectionLevel? PromptInjectionProtectionLevel { get; set; }
        /// <summary>Allow web search in GitLab Duo Chat for this top-level group</summary>
        public bool? WebSearchEnabled { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributes"/> and sets the default values.
        /// </summary>
        public RequestBody44F3C209C81DAiSettingsAttributes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "prompt_injection_protection_level", n => { PromptInjectionProtectionLevel = n.GetEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributesPromptInjectionProtectionLevel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody44F3C209C81DAiSettingsAttributesPromptInjectionProtectionLevel>("prompt_injection_protection_level", PromptInjectionProtectionLevel);
