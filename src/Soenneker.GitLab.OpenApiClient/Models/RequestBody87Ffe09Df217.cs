...
namespace Soenneker.GitLab.OpenApiClient.Models
{
    ...
    public partial class RequestBody87Ffe09Df217 : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217StateEvent? StateEvent { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217"/> and sets the default values.
        /// </summary>
        public RequestBody87Ffe09Df217()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "issue_type", n => { IssueType = n.GetEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217IssueType>(); } },
                ...
                { "severity", n => { Severity = n.GetEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217Severity>(); } },
                { "start_date", n => { StartDate = n.GetStringValue(); } },
                { "state_event", n => { StateEvent = n.GetEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217StateEvent>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217IssueType>("issue_type", IssueType);
            ...
            writer.WriteEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217Severity>("severity", Severity);
            writer.WriteStringValue("start_date", StartDate);
            writer.WriteEnumValue<global::Soenneker.GitLab.OpenApiClient.Models.RequestBody87Ffe09Df217StateEvent>("state_event", StateEvent);
